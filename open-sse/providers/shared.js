...
// OAuth client credentials are supplied by the operator at runtime. Keeping
// them out of the registry prevents credentials from leaking through source
// snapshots and makes forks use their own Google OAuth clients.
export const ANTIGRAVITY_OAUTH_CLIENT = {
  clientId: process.env.RCROUTER_ANTIGRAVITY_OAUTH_CLIENT_ID || "",
  clientSecret: process.env.RCROUTER_ANTIGRAVITY_OAUTH_CLIENT_SECRET || ""
};

// Gemini (Google) OAuth client credentials shared by gemini, gemini-cli, and
// src/lib/oauth. Configure both values to enable these OAuth flows.
export const GOOGLE_OAUTH_CLIENT = {
  clientId: process.env.RCROUTER_GOOGLE_OAUTH_CLIENT_ID || "",
  clientSecret: process.env.RCROUTER_GOOGLE_OAUTH_CLIENT_SECRET || ""
};
