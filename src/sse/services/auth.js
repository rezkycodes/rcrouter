...
function getProviderMutex(providerKey) {
  if (!_providerMutexes.has(providerKey)) {
    _providerMutexes.set(providerKey, Promise.resolve());
  }
...
export async function getProviderCredentials(provider, excludeConnectionIds = null, model = null, options = {}) {
  ...
  let resolveMutex;
  _providerMutexes.set(providerId, new Promise(resolve => { resolveMutex = resolve; }));
